...
export const FTDNA_DISCOVER_Y_DNA_SECTIONS = ['story', 'frequency', 'notable', 'migration', 'globetrekker', 'ancient', 'tree', 'matches', 'path', 'projects', 'scientific', 'compare', 'classic'];

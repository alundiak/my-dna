    ...
    <ul>
      {
        data.map((item: any, index: number) => {
          ...
          return (
            <li key={key}>
              <span>{item.idPublic}</span> | <a href={yResultsURL} target="_blank">yResults</a> | <a href={yColorizedURL} target="_blank">yColorized</a> | <a href={ySNPResultsURL} target="_blank">ysnp</a> | <a href={yMapResultsURL} target="_blank">ymap</a>
            </li>
          );
        })
      }
